namespace eval ::optrace {
  variable script "C:/UART/baseline/project_3/project_3.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/UART/baseline/project_3/project_3.cache/wt [current_project]
  set_property parent.project_path C:/UART/baseline/project_3/project_3.xpr [current_project]
  set_property ip_output_repo C:/UART/baseline/project_3/project_3.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/UART/baseline/project_3/project_3.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/UART/baseline/project_3/project_3.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/UART/baseline/project_3/project_3.srcs/constrs_1/new/uart_top.xdc
