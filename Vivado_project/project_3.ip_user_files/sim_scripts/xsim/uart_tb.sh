...
#
# Script generated by Vivado on Sun Aug 31 05:57:04 -0400 2025
...
#
# Usage        : uart_tb.sh
#                uart_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                uart_tb.sh [-reset_run]
#                uart_tb.sh [-reset_log]
#                uart_tb.sh [-help]
#
...
# script info
echo -e "uart_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./uart_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot uart_tb xil_defaultlib.uart_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim uart_tb -key {Behavioral:sim_1:Functional:uart_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb uart_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./uart_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: uart_tb.sh [-help]\n\
Usage: uart_tb.sh [-step]\n\
Usage: uart_tb.sh [-lib_map_path]\n\
Usage: uart_tb.sh [-reset_run]\n\
Usage: uart_tb.sh [-reset_log]\n\
Usage: uart_tb.sh [-keep_index]\n\
Usage: uart_tb.sh [-noclean_files]\n\n\
